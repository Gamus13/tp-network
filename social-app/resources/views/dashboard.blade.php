<x-app-layout>
    <x-slot name="header">
        ...
        <div class="py-13"> <!--ici plus tu augmente 13 plus le contenue monte pres de la navigtion hrizontal pour creer un ecart c'est 12-->
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="h-screen w-screen flex bg-gray-200"><!-- ceci contient le responsive du contenue-->
        <!-- container -->

        <aside style="height:auto;"
            class="flex flex-col items-center bg-white text-gray-700 shadow">
            <!-- barre de navigation-->
